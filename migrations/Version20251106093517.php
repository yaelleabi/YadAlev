 ...
 */
final class Version20251106093517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE aid_request (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', last_name VARCHAR(100) NOT NULL, first_name VARCHAR(100) NOT NULL, date_of_birth DATE NOT NULL, email VARCHAR(255) NOT NULL, phone_number VARCHAR(20) NOT NULL, housing_status VARCHAR(50) NOT NULL, marital_status VARCHAR(50) NOT NULL, dependants_count INT NOT NULL, employment_status VARCHAR(50) NOT NULL, monthly_income NUMERIC(10, 2) DEFAULT NULL, spouse_employment_status VARCHAR(50) DEFAULT NULL, spouse_monthly_income NUMERIC(10, 2) DEFAULT NULL, family_allowance_amount NUMERIC(10, 2) DEFAULT NULL, alimony_amount NUMERIC(10, 2) DEFAULT NULL, rent_amount_net_aide NUMERIC(10, 2) DEFAULT NULL, status VARCHAR(255) NOT NULL, request_type VARCHAR(50) NOT NULL, request_duration VARCHAR(50) NOT NULL, other_request_duration LONGTEXT DEFAULT NULL, request_reason VARCHAR(50) NOT NULL, other_request_reason LONGTEXT DEFAULT NULL, urgency_explanation LONGTEXT NOT NULL, urgency_level SMALLINT NOT NULL, other_need LONGTEXT DEFAULT NULL, current_situation LONGTEXT NOT NULL, financial_difficulties LONGTEXT NOT NULL, other_comment LONGTEXT DEFAULT NULL, privacy_consent TINYINT(1) NOT NULL, identity_proof_filename VARCHAR(255) DEFAULT NULL, income_proof_filename VARCHAR(255) DEFAULT NULL, tax_notice_filename VARCHAR(255) DEFAULT NULL, other_document_filename VARCHAR(255) DEFAULT NULL, adress_postal_code VARCHAR(255) NOT NULL, adress_street VARCHAR(255) NOT NULL, adress_city VARCHAR(255) NOT NULL, adress_street_number VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, role LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', discr VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
